...
M.get = function()
  ...
  local buffer_opt = type(vim.b.codewindow) == "function" and vim.b.codewindow() or vim.b.codewindow or {}

  ---@type Codewindow.Config
  local global_opt = type(vim.g.codewindow) == "function" and vim.g.codewindow() or vim.g.codewindow or {}
